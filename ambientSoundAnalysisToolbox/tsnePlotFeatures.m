...
%
%   OVERVIEW:
%       Plots the tsne correponding to the alarm audio features.
%
%   INPUT:
%       NONE
%
...
save('mfccFeatures','mfccMat','mfccVar');
save('energyFeatures','energyMat','energyVar');
save('labels','labelMat');
